...
NEXT STEP:          The P8 series: P8a, P8b DONE; P8c BUILT KEY-READY — the
                    Strands reasoning rung (ADR-0057, REQ-1301–1303) assembles
                    its brief and seals llm_raw the first fresh print after
                    OPENAI_API_KEY lands in the environment (model from
                    FINEVENTS_LLM_MODEL, default gpt-5.6-sol). Then P8d — the
                    mini-wiki memory (docs/design/poc-mini-wiki.md). P6
                    (scheduling) follows P8.
